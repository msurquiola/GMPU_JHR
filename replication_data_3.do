...
/* This code generates parts of  Tables 3, 4, 7, 11 in the paper for the track level analysis */
...
outreg2 using Table_track3_school.out, se  bracket  ctitle("IK") replace;
...
outreg2 using Table_track3_school.out, se  bracket  ctitle("CCT") append;
...
outreg2 using Table_track3_school.out, se  bracket  ctitle("IK") append;
...
outreg2 using Table_track4_BCG.out, se  bracket  ctitle("IK") replace;
...
outreg2 using Table_track4_BCG.out, se  bracket  ctitle("CCT") append;
...
outreg2 using Table_track4_BCG.out, se  bracket  ctitle("IK") append;
...
*****TABLE 7 AND APP TABLE 3 - SCHOOL LEVEL ;
...
outreg2 using Table_track7_U_BCG.out, se  bracket  ctitle("IK") replace;
...
outreg2 using Table_track7_U_BCG.out, se  bracket  ctitle("IK") append;
...
outreg2 using Table_track7_U_BCG.out, se  bracket  ctitle("CCT") append;
...
outreg2 using Table_track11_U_BCGR.out, se  bracket  ctitle("IK") replace;
...
outreg2 using Table_track11_U_BCGR.out, se  bracket  ctitle("IK") append;
...
outreg2 using Table_track11_U_BCGR.out, se  bracket  ctitle("CCT") append;
...
outreg2 using Table_track_7_R_BCG.out, se  bracket  ctitle("IK") replace;
...
outreg2 using Table_track_7_R_BCG.out, se  bracket  ctitle("IK") append;
...
outreg2 using Table_track_7_R_BCG.out, se  bracket  ctitle("CCT") append;
...
outreg2 using AppTable_track_3_R_BCGR.out, se  bracket  ctitle("IK") replace;
...
outreg2 using AppTable_track_3_R_BCGR.out, se  bracket  ctitle("IK") append;
...
outreg2 using AppTable_track_3_R_BCGR.out, se  bracket  ctitle("CCT") append;
